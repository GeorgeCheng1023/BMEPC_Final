function [acc, sens, spec, scores, labels] = train_svm_rbf(Xtr, Ytr, Xte, Yte, varargin)
% TRAIN_SVM_RBF Train and test SVM with RBF kernel
%
% Inputs:
...
%              'KernelScale'   - RBF kernel scale (default: 'auto')
...
addParameter(p, 'KernelScale', 'auto');
